# physicsforge-chapter11 - Dual Nature of Radiation and Matter Visual Notes

A premium-style, zero-cost visual notes website for **NCERT Class 12 Physics Chapter 11: Dual Nature of Radiation and Matter**.
...
Create a GitHub repository named `physicsforge-chapter11`, push this project, and use GitHub Pages from the `gh-pages` branch.

```bash
VITE_BASE_PATH=/physicsforge-chapter11/ pnpm build
```
